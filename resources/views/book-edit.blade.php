                ...
                <div class="p-6 bg-white border-b border-gray-200 flex justify-center">
                    <form class="w-full max-w-lg" action="{{route('books.update', $book)}}" method="POST" enctype='multipart/form-data'>
                        ...
                        <div class="md:flex md:items-center mb-6">
                          ...
                          <div class="md:w-2/3">
                            <textarea name="description" class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500" id="inline-password" type="text" >{{$book->description}}</textarea>
                          </div>
                        </div>
